    ...
    def import_from_json(db: ExpenseDatabase, filepath: str) -> int:
        ...
        for expense in expenses:
            try:
                ...
                db.append_expense(
                    category, float(amount_str), description, timestamp=timestamp
                )
                imported_count += 1
        ...
        with open(filepath, "r", newline="", encoding="utf-8") as f:
            ...
            for parts in reader:
                ...
                try:
                    ...
                    db.append_expense(
                        category, amount, description, timestamp=timestamp
                    )
                    imported_count += 1
...
def migrate_legacy_to_db(
    src_path: str = "expenses.txt", db_path: str = "expenses.db"
) -> int:
